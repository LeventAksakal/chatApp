...
public class MockChatClient implements ChatClientInterface, Runnable {
	...
	private static final String[] texts = { "Hello.", "Hi.", "How are you people?", "So what's up?",
			"Why is nobody responding?", "I just arrived.", "I am sorry.", "I don't know what to say.", "How is life?",
			"This is nice.", "How would we do this?", "Okay.", "Where is everybody?", "Oh..." };
	...
	/**
	 * This is here so that null checks are not necessary when trying to call
	 * methods of the listener. If the program has not registered, the methods of
	 * this inner static class will be called, doing nothing. Otherwise, the proper
	 * methods will end up being called.
	 * 
	 * @author safkan
	 *
	 */
	...
	public void sendMessage(Object message) {
		if (message instanceof LoginRequest) {
			...
			throw new IllegalArgumentException(
					"An unknown message type was sent. Type is: " + message.getClass().getName());
		}
	...
	private static String localTimeString() {
		...
		return String.valueOf(LocalTime.now().getHour()) +":"+ String.valueOf(LocalTime.now().getMinute());
	}
